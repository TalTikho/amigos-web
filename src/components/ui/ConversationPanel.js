...
//                     <button
//                         className="settings-btn"             // re‑uses your existing CSS
//                         onClick={() => navigate(`/chat/${chat._id}/details`)}
//                         title="Chat Details"
//                     >
...
const ConversationPanel = ({
    ...
    }, [showForwardModal, chat?._id, user]); // Added chat?._id to dependencies
    ...
    return (
        <div className="conversation-panel">
            ...
            <div className="conversation-header">
                <div className="conversation-avatar">
                    <button
                        ...
                        // **FIX HERE:** Only navigate if chat and chat._id are available
                        onClick={() => chat?._id && navigate(`/chat/${chat._id}/details`)}
                        title="Chat Details"
                    >
                        <AvatarCircle src={chat.photo} radius="40px" />
                    </button>
            ...
            {/* Forward message modal */}{showForwardModal && (
                <ForwardMessageModal
                    message={forwardingMessage}
                    chats={availableChats}
                    onForward={handleCompleteForwarding}
